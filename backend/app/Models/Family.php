...
class Family extends Model {
    use SoftDeletes;
    protected $fillable = ['centre_id','family_name','primary_phone','primary_email','address_line1','address_line2','city','province','postal_code','preferred_lang','billing_split','notes','external_id','external_source'];

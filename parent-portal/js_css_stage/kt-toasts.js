...
(function () {
  ...
  function place(c) {
    if (isMobile()) {
      ...
      c.style.cssText = 'position:fixed;top:auto;bottom:calc(env(safe-area-inset-bottom,0px) + 96px);left:50%;right:auto;transform:translateX(-50%);z-index:2147483600;display:flex;flex-direction:column;align-items:stretch;gap:10px;width:calc(100vw - 24px);max-width:calc(100vw - 24px);max-height:66vh;pointer-events:none;';
    } else {

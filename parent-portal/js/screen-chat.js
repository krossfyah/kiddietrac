      ...
      if (convs.length === 0) {
        container.innerHTML = `
          <div style="text-align:center;padding:48px 16px;color:#6B7280;">
            ...
            ${myRole === 'guardian' ? '<p style="font-size:14px;margin-top:8px;">Your centre will reach out about your child\'s day, or you can start a conversation below.</p>' : ''}
          </div>`;
        return;
      }
      const myId = getUser().id;
      container.innerHTML = `
        <div class="kt-chat-header" style="padding:16px;border-bottom:1px solid #E5E7EB;background:white;">

...
(function (window) {
  ...
  function manualFallback(status, foot, prompt) {
    ...
    inp.type = 'text'; inp.placeholder = 'e.g. K7M2QP'; inp.maxLength = 12;
    inp.setAttribute('autocapitalize', 'characters'); inp.setAttribute('autocomplete', 'off');
    inp.style.cssText = 'flex:1;max-width:220px;padding:12px 14px;border:none;border-radius:12px;font-size:18px;text-transform:uppercase;letter-spacing:2px;text-align:center;';

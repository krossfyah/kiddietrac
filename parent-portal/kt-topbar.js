...
(function () {
  ...
  function buildViewAs(host) {
    ...
    var roles = [['', 'Super admin (default)'], ['agency_admin', '🏢 Agency admin'], ['centre_director', '🏫 Centre director'], ['educator', '🎓 Educator'], ['guardian', '👪 Parent / guardian'], ['home_visitor', '🏡 Home visitor'], ['auditor', '🔍 Auditor']];

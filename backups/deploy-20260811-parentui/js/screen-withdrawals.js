...
(function (window) {
  ...
  async function renderWithdraw(main) {
    ...
    var btn = Dom.el('button', { type: 'button', style: 'margin-top:10px;width:100%;background:linear-gradient(135deg,#0E7C90,#1F6080);color:#fff;border:0;border-radius:12px;padding:13px;font-size:15px;font-weight:800;cursor:pointer;min-height:0;' }, 'Submit request');

...
(function (window) {
  ...
  function show(info) {
    ...
    ov.style.cssText = 'position:fixed;inset:0;z-index:2147481000;background:rgba(11,37,69,.55);display:flex;flex-direction:column;align-items:center;justify-content:center;'

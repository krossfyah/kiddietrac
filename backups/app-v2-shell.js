...
(function (window) {
  ...
  function navItemsForRole(role) {
    if (role === 'agency_admin') {
      ...
      var overviewItems = [{ hash: 'dashboard', label: 'Agency overview', icon: '🏠' }, { hash: 'admin-centres', label: 'Centres & rooms', icon: '🏫' }, { hash: 'provider-map', label: 'Provider map', icon: '🗺️' }];

...
class SuppressAgencyMail
{
    ...
    public function handle(MessageSending $event): bool
    {
        ...
        foreach ($recipients as $addr) {
            ...
            //     the agency master switch is on. Also ABSOLUTE — not exempted by
            //     the allowlist, same as the agency's own toggle.
            if (\App\Support\Suppression::blockedByCentreRoom((int) $uid)) {
                $this->cancel($event, [$addr]);
                return false;
            }
        }

...
(function (window) {
  ...
  function centreRow(centre, monthSel, yearSel) {
    ...
    var status = Dom.el('div', { style: 'font-size:12px;color:#64748B;min-width:180px;text-align:right;' });
    ...
    runBtn.addEventListener('click', async function () {
      ...
      if (!await KT.confirm('Generate invoices for ' + monthLabel + ' ' + year + ' at ' + centre.name + '?\n\n' +

  ...
  async function renderWellness(main) {
    ...
    main.innerHTML = `<div style="padding:24px;max-width:1800px;margin:0 auto;">
      ...
      <div class="kt-card">
        ...
        <button id="ws-submit" class="kt-btn kt-btn-primary" style="margin:16px auto 0;display:block;width:fit-content;min-height:0;padding:11px 26px;font-size:14px;font-weight:700;">Submit screening</button>
